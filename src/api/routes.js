...
module.exports = function(app) {
  ...
  //routes for deploments with ID
//  apiRoutes.post('/organizations/:organizationId/projects/:projectId/applications/:applicationId/deploy', ApplicationController.newdeployApi);
  apiRoutes.post('/organizations/:organizationId/projects/:projectId/applications/:applicationId/deploy', ApplicationController.newservice);
//  apiRoutes.post('/organizations/:organizationId/projects/:projectId/applications/:applicationId/deploymentId', ApplicationController.newdeployApi);
//  apiRoutes.post('/organizations/:organizationId/projects/:projectId/applications/:applicationId/deploymentId', ApplicationController.newservice);
