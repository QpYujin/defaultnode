    ...
    angular.module('masonry', ['ng']).directive('masonry', function($timeout) {
        return {
            ...
            link: function(scope, elem, attrs) {
                ...
                var masonry = scope.masonry = new Masonry(container, scope.options);
                ...
                scope.update = function() {
                    ...
                    debounceTimeout = $timeout(function() {
                        ...
                        elem.children(scope.options.itemSelector).css('visibility', 'visible');
                    }, 120);
                };
                ...
                scope.$on('reloadMasonry', function () {
                    masonry.reloadItems();
                    $timeout(function () {
                        scope.update();
                    })
