...
app.directive('iframeDirective', ['$sce', function($sce) {
  return {
    ...
    link: function(scope) {
      ...
      scope.mysite=$sce.trustAsResourceUrl("https://api.deploybytes.com/api/v1/proxy/namespaces/kube-system/services/kibana-logging/goto/9efb4a8216d5d26005312f0dd66457a9")}
